...
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    using TileShape_MNK_V = typename Kernel_traits::TileShape_MNK_V;
    ...
    typename CollectiveMainloop::Params mainloop_params =
        CollectiveMainloop::to_underlying_arguments({
            ...
            seqlen_traits_k.get_gmem_layout(
                params.seqlen_k, params.vd, params.h_k, params.b_k, 
    ...
    typename CollectiveEpilogue::Params epilogue_params = [&] {
        if constexpr(!Is_split) {
            return CollectiveEpilogue::to_underlying_arguments({            
                ...
                seqlen_traits_q.get_gmem_layout(
                    params.seqlen_q, params.vd, params.h_k, params.b, params.h_h_k_ratio, 
            ...
            return CollectiveEpilogue::to_underlying_arguments({
                ...
                seqlen_traits_q.get_oaccum_gmem_layout(
                    params.seqlen_q, params.vd, params.h_k, params.b, params.h_h_k_ratio, params.num_splits,
    ...
    if constexpr (Is_split) {
      ...
      constexpr static int kQKHeadDim = Kernel_traits::kQKHeadDim;
      constexpr static int kVHeadDim = Kernel_traits::kVHeadDim;
      constexpr static int kBlockM = kVHeadDim % 128 == 0 ? 4 : (kVHeadDim % 64 == 0 ? 8 : 16); // TODO: check kQKHeadDim
      ...
      NUM_SPLITS_SWITCH(params.num_splits, kLogMaxSplits, [&] {
        ...
        kernel_combine = (void *) flash::combine_attn_seqk_parallel<
          FinalOutputType, ElementAccum, kVHeadDim, kBlockM, kLogMaxSplits, Is_even_K, Flash_fwd_params>;
          ...
          SEQLEN_SWITCH(params.cu_seqlens_q, Seqlen_traits, [&] {
            BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
              ...
              //             && kNumMmaWGs == 3 && !Seqlen_traits::UseVarSeqLen, UseCluster, [&] {
                run_flash_fwd<
                  Flash_fwd_kernel_traits<Headdim, Headdim, kNumMmaWGs * 64, 128, 4 + kNumMmaWGs * 4,
          ...
          SEQLEN_SWITCH(params.cu_seqlens_q, Seqlen_traits, [&] {
            BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
              ...
              BOOL_SWITCH(cutlass::ceil_div(params.seqlen_q, 128) % 2 == 0 && !Is_causal && !Is_local && !Is_split
                ...
                run_flash_fwd<
                  Flash_fwd_kernel_traits<Headdim, Headdim, kNumMmaWGs * 64, (Is_causal || Is_local) ? 128 : 176,
          ...
          SEQLEN_SWITCH(params.cu_seqlens_q, Seqlen_traits, [&] {
            BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
              ...
              BOOL_SWITCH(cutlass::ceil_div(params.seqlen_q, 128) % 2 == 0 && !Is_causal && !Is_local && !Is_split
                          && kNumMmaWGs == 2 && !Seqlen_traits::UseVarSeqLen, UseCluster, [&] {
                run_flash_fwd<
                  Flash_fwd_kernel_traits<Headdim, Headdim, kNumMmaWGs * 64, kNumMmaWGs == 1 ? 96 : 80,
                      4 + kNumMmaWGs * 4, 2, false, UseCluster ? 2 : 1,
                      T, !Seqlen_traits::UseVarSeqLen && Is_split>, 
                  Is_causal,
                  Is_local && !Is_causal,
        ...
        BOOL_SWITCH(params.is_local, Is_local, [&] {
          BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
            BOOL_SWITCH(cutlass::ceil_div(params.seqlen_q, 192) % 2 == 0 && !Is_causal && !Is_local && !Is_split
              ...
              run_flash_fwd<
                Flash_fwd_kernel_traits_fp8<Headdim, Headdim, kNumMmaWGs * 64, kBlockN, 4 + kNumMmaWGs * 4,
        ...
        MMA_3WG_SWITCH(params.seqlen_q, kNumMmaWGs, [&] {
          SEQLEN_SWITCH(params.cu_seqlens_q, Seqlen_traits, [&] {
            BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
              ...
              //             && kNumMmaWGs == 3 && !Seqlen_traits::UseVarSeqLen, UseCluster, [&] {
                run_flash_fwd<
                  Flash_fwd_kernel_traits<QKHeaddim, VHeaddim, kNumMmaWGs * 64, 128, 4 + kNumMmaWGs * 4,
                      2, false, UseCluster ? 2 : 1, T, !Seqlen_traits::UseVarSeqLen && Is_split>,
                  Is_causal,
                  Is_local && !Is_causal,
                  Seqlen_traits
...
template<typename T>
void run_mha_fwd_qkdim32_vdim64_fp8(Flash_fwd_params &params, cudaStream_t stream) {
    constexpr static int QKHeaddim = 32;
    constexpr static int VHeaddim = 64;
    constexpr static int kBlockN = 128;
    constexpr static int kStages = 4;
        ...
        BOOL_SWITCH(params.is_local, Is_local, [&] {
          BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
            BOOL_SWITCH(cutlass::ceil_div(params.seqlen_q, 192) % 2 == 0 && !Is_causal && !Is_local && !Is_split
                        && kNumMmaWGs == 3, UseCluster, [&] {
              run_flash_fwd<
                Flash_fwd_kernel_traits_fp8<QKHeaddim, VHeaddim, kNumMmaWGs * 64, kBlockN, 4 + kNumMmaWGs * 4,
                  kStages, false, UseCluster ? 2 : 1, T, Is_split>,
                Is_causal,
                Is_local && !Is_causal,
                Seqlen_traits
...
template<typename T, int kBlockH>
void run_mha_fwd_qkdim32_vdim64_gqa(Flash_fwd_params &params, cudaStream_t stream) {
    constexpr static int QKHeaddim = 32;
    constexpr static int VHeaddim = 64;
  constexpr static bool UseCluster = false;
  using Seqlen_traits = flash::FixedSeqLenTraits;
...
template<typename T, int kBlockH>
void run_mha_fwd_qkdim32_vdim64_fp8_gqa(Flash_fwd_params &params, cudaStream_t stream) {
    constexpr static int QKHeaddim = 32;
    constexpr static int VHeaddim = 64;
  constexpr static int kBlockN = 128;
  constexpr static int kStages = 4;
          ...
          SEQLEN_SWITCH(params.cu_seqlens_q, Seqlen_traits, [&] {
            BOOL_SWITCH(params.num_splits > 1, Is_split, [&] {
              ...
              BOOL_SWITCH(cutlass::ceil_div(params.seqlen_q, 128) % 2 == 0 && !Is_causal && !Is_local && !Is_split
                          && kNumMmaWGs == 2 && !Seqlen_traits::UseVarSeqLen, UseCluster, [&] {
                run_flash_fwd<
                  Flash_fwd_kernel_traits<QKHeaddim, VHeaddim, kNumMmaWGs * 64, kNumMmaWGs == 1 ? 96 : 80,
                      4 + kNumMmaWGs * 4, 2, false, UseCluster ? 2 : 1,
                      T, !Seqlen_traits::UseVarSeqLen && Is_split>, 
                  Is_causal,
                  Is_local && !Is_causal,
...
template<typename T>
void run_mha_fwd_qkdim128_vdim256_fp8(Flash_fwd_params &params, cudaStream_t stream) {
  constexpr static int QKHeaddim = 128;
  constexpr static int VHeaddim = 256;
    constexpr static int kBlockN = 128;
    constexpr static int kStages = 2;
...
template<typename T, int kBlockH>
void run_mha_fwd_qkdim128_vdim256_gqa(Flash_fwd_params &params, cudaStream_t stream) {
  constexpr static int QKHeaddim = 128;
  constexpr static int VHeaddim = 256;
  constexpr static bool UseCluster = false;
  using Seqlen_traits = flash::FixedSeqLenTraits;
...
template<typename T, int kBlockH>
void run_mha_fwd_qkdim128_vdim256_fp8_gqa(Flash_fwd_params &params, cudaStream_t stream) {
  constexpr static int QKHeaddim = 128;
  constexpr static int VHeaddim = 256;
  constexpr static int kBlockN = 128;
  constexpr static int kStages = 2;
